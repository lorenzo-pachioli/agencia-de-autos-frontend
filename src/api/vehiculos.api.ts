...
export const vehiculosApi = {
  listar: () => publicApiClient.get('/vehiculos'),
  obtener: (id: number) => publicApiClient.get(`/vehiculos/${id}`),
  ...
  busqueda: (filtros: VehiculoFiltros) => publicApiClient.get('/vehiculos/busqueda', { params: filtros }),
